...
const NOTICIAS: Record<string, NoticiaDetalle> = {
  '1': {
    ...
    resumen:
      'Descubre las últimas tendencias y tecnologías que impulsan la agroindustria este año.',
    fecha: '24 de febrero de 2026, 12:30 p. m.',
    imagen: 'agroindustria',
  },
  '2': {
    titulo: 'La importancia de la agricultura sostenible en tiempos de cambio climático',
    resumen:
      'Estrategias para producir más, conservar el suelo y aprovechar mejor los recursos disponibles.',
    fecha: '24 de febrero de 2026, 10:15 a. m.',
    imagen: 'sostenible',
  },
  '3': {
    ...
    fecha: '24 de enero de 2026, 9:00 a. m.',
    imagen: 'ganaderia',
  },
  '4': {
    ...
    fecha: '20 de enero de 2026, 3:20 p. m.',
    imagen: 'tecnologia',
  },
  '5': {
    ...
    fecha: '18 de enero de 2026, 11:40 a. m.',
    imagen: 'economia',
  },
};
...
export class NoticiaDetalleComponent {
  ...
  protected readonly noticia = computed(
    () => NOTICIAS[this.route.snapshot.paramMap.get('id') ?? '1'] ?? NOTICIAS['1'],
  );
}
